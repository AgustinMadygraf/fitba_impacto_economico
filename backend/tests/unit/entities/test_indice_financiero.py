...
def test_indice_financiero_acumulado_lineal():
    ...
    assert round(indice.obtener_factor_acumulado(1), 4) == 1.0400
    assert round(indice.obtener_factor_acumulado(2), 4) == 1.0816
...
def test_indice_financiero_acumulado_proyectado():
    ...
    assert round(indice.obtener_factor_acumulado(2), 3) == 1.155
